...
[] spawn {
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBar")displayCtrl 1000)ctrlSetText format["JOIN TEAMSPEAK SERVER IP: 188.228.38.201  FPS: %1 | PLAYERS: %2 | SERVER RESTART IN ABOUT: %3:%4", round diag_fps, count playableUnits, _hours, _minutes, _counter];
	}; 
};
